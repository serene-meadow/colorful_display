...
var ASM_CONSTS = {
 ...
 147812: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 147895: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 147964: () => { return window.innerWidth; },  
 147994: () => { return window.innerHeight; }
};
