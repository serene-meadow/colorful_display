...
var ASM_CONSTS = {
 ...
 148308: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 148391: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 148460: () => { return window.innerWidth; },  
 148490: () => { return window.innerHeight; }
};
